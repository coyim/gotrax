...
func (s *GotraxSuite) Test_generateSignature_generatesACorrectSignature(c *C) {
	...
	c.Assert(rsig.C1.Encode(), DeepEquals, []byte{
		...
		0x1f, 0x16, 0x34, 0x95, 0xf1, 0xf5, 0x31, 0x1f,
		0x1d, 0xce, 0x4e, 0xfd, 0x33, 0x4a, 0xe8, 0x7e,
		0xd7, 0xd1, 0x1e, 0x71, 0x54, 0x4c, 0x5e, 0xed,
		0xf1, 0x98, 0x6d, 0x43, 0x6a, 0x7e, 0x5b, 0xd3,
		0x93, 0x36, 0xd9, 0xf6, 0x33, 0x27, 0x31, 0xd9,
		0x5d, 0x60, 0x32, 0xe1, 0xfe, 0xd6, 0xce, 0x2c,
	})
	c.Assert(rsig.R1.Encode(), DeepEquals, []byte{
		0x7f, 0xb6, 0x4a, 0x1, 0x7d, 0xa0, 0x78, 0x5c,
		0x8a, 0xbb, 0xba, 0xc5, 0x42, 0x85, 0xf9, 0x6a,
		0xdc, 0xd9, 0x8, 0x2f, 0x50, 0x12, 0xa6, 0x93,
		0x6c, 0x7b, 0x36, 0x57, 0x17, 0x9f, 0x33, 0x23,
		0x4d, 0x49, 0xb8, 0xd0, 0x3d, 0xf5, 0xb5, 0xe5,
		0x86, 0x4, 0x9a, 0x2d, 0xb7, 0x9f, 0xfa, 0xf,
